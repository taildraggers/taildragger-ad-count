...
- That script:
  1. Fetches every other taildraggers.com scraper repo's published GitHub
     ...
     bellanca, cub-crafters, american-champion, de-Havilland, extra,
     great-lakes, just-aircraft, airtractor, fairchild, stinson) and pulls
     the listing count out of each page's "N listing(s)" line.
